...
import { Brain, Clock, Shield, TrendingUp, DollarSign, Zap } from "lucide-react";
...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-background">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white overflow-hidden pt-28">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {features.map((feature, index) => (
              <motion.div
                ...
                viewport={{ once: true }}
              >
                <Card className="text-center p-8 bg-neutral-50 hover:shadow-lg transition-all transform hover:-translate-y-2 h-full">
